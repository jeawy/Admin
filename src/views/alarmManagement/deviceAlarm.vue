...
export default {
  ...
  methods: {
    ...
    filter(){
      let status =""
      if(this.$route.params.name == "新增"){
        status = 0
        this.alarmStatus = "新增"
      }
      if(this.$route.params.name == "忽略"){
        status = 1
        this.alarmStatus = "忽略"
      }
      if(this.$route.params.name == "关闭"){
        status = 2
        this.alarmStatus = "关闭"
      }
      if(this.$route.params.name == "误报"){
        status = 3
        this.alarmStatus = "误报"
      }
      if(this.$route.params.name == "已处置"){
        status = 4
        this.alarmStatus = "已处置"
      }
      let data = {
