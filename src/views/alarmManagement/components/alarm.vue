    ...
    <el-row class="row-bg" :gutter="20">
      ...
      <el-col class="col-bg">
        ...
        <el-select class="select" v-model="alarmCategory" placeholder="请选择" filterable>
          <el-option
            v-for="item in warnCategoryList"
            :key="item.value"
            :label="item.name"
            :value="item.code"
          ></el-option>
      ...
      <el-col>
        <el-button type="primary" class="btn" icon="el-icon-search" @click="search()">点击查询</el-button>
      </el-col>
      <el-col>
          ...
          <el-row>
            <el-col :span="24">
              <el-row>
                ...
                <el-col :span="16">
                  <el-input v-model="wellid" placeholder="请输入井的ID" />
                </el-col>
              </el-row>
              ...
              <el-row>
                ...
                <el-col :span="16">
                  <el-input v-model="alarmTitle" placeholder="请输入告警标题" />
                </el-col>
              </el-row>
              <el-row style="height:8px" />
              <el-row>
              ...
              <el-row>
                ...
                <el-col :span="16">
                  <el-input v-model="content" placeholder="请输入告警内容" />
                </el-col>
              </el-row>
              <el-row style="height:8px" />
              <el-row>
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-button type="primary" size="mini" @click="addWell">确定</el-button>
                </el-col>
              </el-row>
            </el-col>
          </el-row>
      ...
      <el-col>
        ...
        >
          <div class="drawer_content" style="margin-left:20px">
            ...
            <el-row>
              <el-col :span="12">
                油压不在范围：
                <el-input v-model="oil_pressure1" style="width:40px" />至
                <el-input v-model="oil_pressure2" style="width:40px" />
              </el-col>
              <el-col :span="12">
                动液面不在范围：
                <el-input v-model="level1" style="width:40px" />至
                <el-input v-model="level2" style="width:40px" />
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="12">
                日产量不在范围：
                <el-input v-model="output1" style="width:40px" />至
                <el-input v-model="output2" style="width:40px" />
              </el-col>
              <el-col :span="12">
                平衡度不在范围：
                <el-input v-model="balance1" style="width:40px" />至
                <el-input v-model="balance2" style="width:40px" />
              </el-col>
            </el-row>
            <el-row style="height:15px" />
            <el-row>
              <el-col :span="12">
                电压不在范围：
                <el-input v-model="voltage1" style="width:40px" />至
                <el-input v-model="voltage2" style="width:40px" />
              </el-col>
              <el-col :span="12">
                电流不在范围：
                <el-input v-model="electric_current1" style="width:40px" />至
                <el-input v-model="electric_current2" style="width:40px" />
              </el-col>
            </el-row>
            <el-row style="height:15px" />
            <el-row>
              <el-col :span="12">
                有功不在范围：
                <el-input v-model="active1" style="width:40px" />至
                <el-input v-model="active2" style="width:40px" />
              </el-col>
              <el-col :span="12">
                油温不在范围：
                <el-input v-model="oil_temperature1" style="width:40px" />至
                <el-input v-model="oil_temperature2" style="width:40px" />
              </el-col>
            </el-row>
            <el-row style="height:15px" />
            <el-row>
              ...
              <el-col :span="12">
                载荷不在范围：
                <el-input v-model="burden1" style="width:40px" />至
                <el-input v-model="burden2" style="width:40px" />
              </el-col>
            </el-row>
            <el-row style="height:15px" />
            <el-row>
              <el-col :span="12">
                频率不在范围：
                <el-input v-model="frequency1" style="width:40px" />至
                <el-input v-model="frequency2" style="width:40px" />
              </el-col>
              <el-col :span="12">
                套压不在范围：
                <el-input v-model="nesting_pressure1" style="width:40px" />至
                <el-input v-model="nesting_pressure2" style="width:40px" />
              </el-col>
            </el-row>
            <el-row style="height:15px" />
        ...
        <el-button type="primary" class="btn" style="height:27.99px" @click="targetUpload" icon="el-icon-download">导出结果</el-button>
      </el-col>
    </el-row>
    <el-table
      :data="alarmList"
    ...
    >
      ...
      <el-table-column width="140" label="告警类型" align="left" prop="category">
        <!-- <template slot-scope="scope">
          ...
          <div v-if="scope.row.category==1">{{scope.row.category|alarmCategory}}</div>
      ...
      <el-table-column width="140" label="产生方式" align="left">
        <template slot-scope="scope">
          ...
          <div v-if="scope.row.way==1">
            ...
            <div v-if="scope.row.way==2">
            <span>{{scope.row.way|alarmWay}}</span>
           
          </div>
        </template>
      </el-table-column>
      <el-table-column label="告警时间" width="180px" align="left">
        <template slot-scope="scope">{{scope.row.date|dateTimeFormat}}</template>
      </el-table-column>
      <el-table-column width="110" label="告警状态" align="left">
        <template slot-scope="scope">
          <el-select
            v-model="alarmStatus"
            placeholder="请选择"
      ...
      <el-table-column width="110" label="告警处置" align="left">
        <template slot-scope="scope">
          <router-link
      ...
      <el-table-column prop="username" width="90" label="处置人" align="left"></el-table-column>
      <el-table-column label="处置时间" width="180px" align="left">
...
export default {
  ...
  methods: {
    ...
    //获取告警列表
    GetalarmList() {
      ApiAlarmQuery({ page: this.currentPage, pagenum: this.pageSize }).then(
        ({ data }) => {
    ...
    search() {
      ...
      if (this.alarmDatePicker == "") {
        ...
        this.alarmDate =
          this.alarmDatePicker[0] + "-" + this.alarmDatePicker[1];
      }
      if (this.handleDatePicker == "") {
        this.handleDate = "";
      } else {
        this.handleDate =
          this.handleDatePicker[0] + "-" + this.handleDatePicker[1];
      }
      let data = {
