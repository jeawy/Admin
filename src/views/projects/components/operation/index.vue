    ...
    <div>
        <div style="padding-top:10px;">
          <div style="padding-bottom:10px;" v-if="auth">
            ...
            <el-button type="warning" @click="openDialog(5)" size="medium" v-if="auth"
            >直接指令发送</el-button>
        ...
        <div class="diag-footer">
          <el-dialog title="参量调整" :visible.sync="dialogVisible1" width="500px">
            <el-form :model="paramModal" ref="paramModal" :rules="rules">
              ...
              <el-form-item label="大平衡块重量 (千牛)" prop="param_balance_big_weight" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
              ...
              <el-form-item label="小平衡块重量 (千牛)" prop="param_balance_small_weight" placeholder="千瓦" v-if="wellDetail.well_type ==0">
                  <el-input-number
      ...
      switch (Type) {
        case 1:
          ...
          this.options.forEach((item,index)=>{
            if(item.series == this.wellDetail.machine_type){
